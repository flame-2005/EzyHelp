...
const Login = () => {
  ...
  return (
    <div className="mt-14 py-10 w-full h-full bg-gradient-to-r from-white to-black overflow-hidden">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-4">
              <div className="flex justify-between">
                ...
                {/* <a href="#" className="bg-left-bottom bg-gradient-to-r text-sm from-blue-400 to-blue-400 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out">Forget Password?</a> */}
              </div>
              <input
                className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                type="password"
